...
func (fn UpdateSpoonHandlerFunc) Handle(params UpdateSpoonParams, principal *models.Principal) middleware.Responder {
...
func NewUpdateSpoon(ctx *middleware.Context, handler UpdateSpoonHandler) *UpdateSpoon {
	return &UpdateSpoon{Context: ctx, Handler: handler}
}
...
func (o *UpdateSpoon) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewUpdateSpoonParams()
