...
// DestroySpoonParams contains all the bound params for the destroy spoon operation
...
func (o *DestroySpoonParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
