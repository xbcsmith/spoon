...
// NewGetLivenessParamsWithTimeout creates a new GetLivenessParams object
...
// NewGetLivenessParamsWithContext creates a new GetLivenessParams object
...
// NewGetLivenessParamsWithHTTPClient creates a new GetLivenessParams object
...
/*GetLivenessParams contains all the parameters to send to the API endpoint
for the get liveness operation typically these are written to a http.Request
*/
